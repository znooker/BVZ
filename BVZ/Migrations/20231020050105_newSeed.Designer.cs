...
namespace BVZ.Migrations
{
    ...
    [Migration("20231020050105_newSeed")]
            ...
            modelBuilder.Entity("BVZ.BVZ.Domain.Models.Visitors.ZooTour", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DateOfTour = new DateTime(2023, 10, 20, 7, 1, 4, 949, DateTimeKind.Local).AddTicks(4103),
                            IsMorningTour = true,
                            NrOfParticipants = 0,
                        ...
                        new
                        {
                            ...
                            DateOfTour = new DateTime(2023, 10, 20, 7, 1, 4, 949, DateTimeKind.Local).AddTicks(4125),
                            IsMorningTour = false,
                            NrOfParticipants = 0,
                            TourID = new Guid("00000000-0000-0000-0000-444000000000"),
                            ZooDayId = new Guid("00000000-0000-0000-0000-123000000000")
                        ...
                        new
                        {
                            ...
                            DateOfTour = new DateTime(2023, 10, 20, 7, 1, 4, 949, DateTimeKind.Local).AddTicks(4163),
                            IsMorningTour = true,
                            NrOfParticipants = 0,
                        ...
                        new
                        {
                            ...
                            DateOfTour = new DateTime(2023, 10, 20, 7, 1, 4, 949, DateTimeKind.Local).AddTicks(4184),
                            IsMorningTour = false,
                            NrOfParticipants = 0,
                            TourID = new Guid("00000000-0000-0000-0000-444400000000"),
                            ZooDayId = new Guid("00000000-0000-0000-0000-123000000000")
            ...
            modelBuilder.Entity("BVZ.BVZ.Domain.Models.Zoo.ZooDay", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Archived = false,
                            TodaysDate = new DateTime(2023, 10, 20, 7, 1, 4, 949, DateTimeKind.Local).AddTicks(4050)
                        });
                });
